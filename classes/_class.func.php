...
class func{
	...
	public function md5Password($pass){
		...
		return md5("wmrush_by_edition"."-".$pass);
	...
	/*======================================================================*\
	Function:	Base64en
	Descriiption: Возвращает Base64_encode
	\*======================================================================*/
	public function Base64en($str){
		//$pass = strtolower($pass);
	...
	/*======================================================================*\
	Function:	Base64de
	Descriiption: Возвращает Base64_decode
	\*======================================================================*/
	public function Base64de($str){
		//$pass = strtolower($pass);
	...
	public function SumCalc($per_h, $sum_tree, $last_sbor){
		...
		if($last_sbor > 0){
			...
			if($sum_tree > 0 AND $per_h > 0){
				...
				return sprintf("%.2f",  ($per_sec * $sum_tree) * $last_sbor);
