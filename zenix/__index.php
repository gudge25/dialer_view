...
<head>
    ...
    <title>ТЕЦ - Admin Dashboard </title>
    <!-- Favicon icon -->
...
-=-	
        ...
        ***********************************-->
            ...
            <div class="deznav-scroll">
				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">ТЕЦ</span>
						</a>
                        <ul aria-expanded="false">
							<li><a href="/">Черкаська ТЕЦ</a></li>
		...
		<p><strong><a href="">ITStudio</a></strong> © 2021 All Rights Reserved</p>
        ...
        ***********************************-->
		...
		if(isset($_GET["menu"])){
			...
			switch($menu){
				...
				case "table": include("pages/_table.php"); break; // Вход
				...
				case "payments": include("pages/_payments_list.php"); break; // Выплатыг
                case "insert": include("pages/_story_insert.php"); break; // Пополнения
				case "top": include("pages/_top.php"); break;
                case "faq": include("pages/_faq.php"); break;
                case "login": include("pages/_login.php"); break; // Вход
                case "insertadv": include("pages/account/_insertadv.php"); break; 
		...
		}else include "pages/_disboard.php"; 
